...
def create_final_data(api, trending_topics, lang="en", num_tweets=50, result_type="mixed"):
	...
	for topic in trending_topics:
		...
		top_tweets = search_trend(trend_name, api, lang, num_tweets, result_type) 
...
def save_json_file(json_data, temp_files_path, file_name=f'TweetsData-{date.today()}.json'):
	"""
...
def extract_trending_tweets(CONSUMER_KEY, 
	...
	for country in countries:
		...
		# Salva json file.
		save_json_file(json_tweets, temp_json_files, file_name)
